...
const Employment = () => {
  ...
  return (
    <><div className="bg-cover bg-[#ffffff] bg-fixed pb-[10%]"><div className="px-[10%] mx-[8.5%] pt-[22%] md:pt-[8%] text-xl">
        <div className="text-4xl font-bold my-7">Employment</div>
        <div className="xl:bg-[#f6f6f6] h-min rounded-xl xl:shadow-md xl:p-10">
                <div className="pb-4">Click&nbsp;<a className="font-bold text-blue-500 hover:text-blue-700 transition ease-in duration-200" href="/vectorapp.pdf" target="_blank" rel="noopener noreferrer">HERE</a>&nbsp;to download the Vector Employment PDF. You can print, complete, and mail or fax to us.</div>
